...
#	you know your DNS is pointing correctly and you did everything right. Or if its' a new site or you don't have a
#	zip file.
...
#   it until the final step of the prompts. When asked for the Challenge password it is not the same thing as the key it #	asked for in the beggining. You can 	 		leave this blank if not you may need to provide it to your SSL
